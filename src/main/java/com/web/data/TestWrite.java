...
public class TestWrite {
    public static void main(String[] args) throws IOException {
    	 StringBuilder urlBuilder = new StringBuilder("http://openapi.q-net.or.kr/api/service/rest/InquiryStatSVC/getEventYearPiList"); /*URL*/
         ...
         urlBuilder.append("&" + URLEncoder.encode("jmCd","UTF-8") + "=" + URLEncoder.encode("7960", "UTF-8")); /*종목코드*/
